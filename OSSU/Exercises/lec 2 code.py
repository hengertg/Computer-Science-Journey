...
# result = user_guess==secret_number
# print(result)
# Also this can work
# print(user_guess==secret_number)
...
# your code here
secret = 17
user_guess = float(input("Guess a number: "))

if user_guess == secret:
    print("you guessed the secret number")
elif user_guess < secret:
    print(f"The number {user_guess} is low than the secret number")
else:
    print(f" The number {user_guess} is higher than the secret number")
print("Thank you")
